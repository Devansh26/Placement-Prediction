<?php 
    ...
    */
    ...
    $sql=mysqli_query($con,"select * from users where name='$user' ");
    ...
    $index_selecting_quiz = mysqli_query($conn,"SELECT quiz_id, display_questions, time_allotted, quiz_name
                                    FROM quizes WHERE set_default='".$level."'");
...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function submit(){
                var x=document.forms["onlyForm"]["email"].value;
                if (x==null || x==""){
    ...
    <body style="font-family: Arial;">
        <div id="head" align="center">
            <h6>Xavier Institute Of Engineering</h6>
        </div>
        ...
        <div id="main_body" align="center">
            ...
            <form id="myForm" name="onlyForm" action="quiz.php" method="POST">
                <table align="center">
                    <tr>
                        <td align="center">
                            <input type="text" name="email" size="40" value="<?php echo$user;?>" readonly/>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
