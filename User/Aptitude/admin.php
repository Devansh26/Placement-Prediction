 ...
 //checking if the required data has been filled
	if(isset($_POST['desc'])){
	 ...
	 //inserting the question and type into table question
		$sql = mysqli_query($conn,"INSERT INTO questions (quiz_id, question, code, code_type, type) VALUES ('$quizID', '$question', '$program', '$programType', '$type')")or die(mysql_error());
		//lastId is there, so we can insert the id, question_id in our table
			$lastId = mysqli_insert_id();
			mysqli_query($conn,"UPDATE questions SET question_id='$lastId' WHERE id='$lastId' LIMIT 1")or die(mysql_error());

	 ///////Updating value of total questions in quizes
		mysqli_query($conn,"UPDATE quizes SET total_questions=total_questions+1 WHERE quiz_id='$quizID' LIMIT 1")or die(mysql_error());
		...
		if($type == 'tf'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '1')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysql_error());
		 ...
		 //if answer2 is marked correct, do this--
			if($isCorrect == "answer2"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '1')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
				header('location: admin.php?msg='.$msg.'');
				exit();
			}	
		...
		if($type == 'mc'){
		 //if answer1 is marked correct, do this--
			if($isCorrect == "answer1"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '1')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '0')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
			  	header('location: admin.php?msg='.$msg.'');
				exit();
			}
		 ...
		 //if answer3 is marked correct, do this--
			if($isCorrect == "answer3"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '1')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '0')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
		 ...
		 //if answer4 is marked correct, do this--
			if($isCorrect == "answer4"){
				$sql2 = mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer4', '1')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer1', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer2', '0')")or die(mysql_error());
				mysqli_query($conn,"INSERT INTO answers (quiz_id, question_id, answer, correct) VALUES ('$quizID', '$lastId', '$answer3', '0')")or die(mysql_error());
				$msg = 'Thanks, question no.'.$lastId.' has been added';
...
//if resetTables is clicked
	if(isset($_POST['resetTables']) && $_POST['resetTables'] != ""){
		...
		if($resetT=='yes'){
			mysqli_query($conn,"TRUNCATE TABLE admins")or die(mysql_error());
			mysqli_query($conn,"TRUNCATE TABLE answers")or die(mysql_error());
			mysqli_query($conn,"TRUNCATE TABLE questions")or die(mysql_error());
			mysqli_query($conn,"TRUNCATE TABLE quizes")or die(mysql_error());
			mysqli_query($conn,"TRUNCATE TABLE quiz_takers")or die(mysql_error());
...
//When editaquestion is clicked
	...
	if(isset($_POST['editaquestion']) && $_POST['editaquestion'] != ""){
		...
		if($editQ=='allthequestions')
			$multipleSQL = mysqli_query($conn,"SELECT * FROM questions") or die(mysql_error());
		else
...
//if deleteAdmin is clicked, check--
	if(isset($_POST['deleteAdmin']) && $_POST['deleteAdmin'] != ""){
		...
		mysqli_query($conn,"DELETE FROM admins WHERE username = '$deleteA'")or die(mysql_error());
...
//if defaultQuiz is clicked, check--
	if(isset($_POST['defaultQuiz']) && $_POST['defaultQuiz'] != ""){
	 ...
	 ///////Updating value of set_default in quizes
		mysqli_query($conn,"UPDATE quizes SET set_default=0 WHERE set_default=1")or die(mysql_error());
		mysqli_query($conn,"UPDATE quizes SET set_default=1 WHERE quiz_name='$defaultQ'")or die(mysql_error());


 //checking if update is successful
	//getting rows from tables
		$defaultQ_sql1 = mysqli_query($conn,"SELECT id FROM quizes WHERE set_default=1")or die(mysql_error());
...
//if clearResult is clicked, check--
	...
	//deleting
		mysqli_query($conn,"DELETE FROM quiz_takers WHERE quiz_id='$clearR'")or die(mysql_error());
...
//if reset is clicked, check--
 ...
 //checking if truncate is successful
	//getting rows from tables
		$sql1 = mysqli_query($conn,"SELECT id FROM questions LIMIT 1")or die(mysql_error());
		$sql2 = mysqli_query($conn,"SELECT id FROM answers LIMIT 1")or die(mysql_error());
	//getting number of rows that were returned
...
//if deleteQuiz is clicked, check--
	...
	//resetting the tables
		...
		mysqli_query($conn,"DELETE FROM quizes WHERE quiz_id = '$qz_id'")or die(mysql_error());
		mysqli_query($conn,"DELETE FROM questions WHERE quiz_id = '$qz_id'")or die(mysql_error());
		mysqli_query($conn,"DELETE FROM answers WHERE quiz_id = '$qz_id'")or die(mysql_error());
...
*/
	...
	<body style="font-family: Arial;">
		...
		<div id="head" align="center">
            <img src="../../images/x.jpg" width="700" height="180" alt="Xavier Institute Of Engineering" />
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center" id="video_link">
                            Home?!
                            <a href="../../Admin/index.php" style="color: #c4dcf5">
                                Back</a>
                            To Your Admin Panel!
                        </td>
                        <td align="right" id="developer" >
                            ...
                            <a href="mailto: rahul_jain@live.in" class="flink" style="color: #c4dcf5">
                                SDR<div id="dev_info">1139234/CSE/6thSEM</div>
                            </a>
                        </td>
                    </tr>
                </tbody>
