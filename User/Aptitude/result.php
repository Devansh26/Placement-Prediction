    ...
    if(isset($_POST["total_ques"]) && isset($_POST["rollno"]) && isset($_POST["quizID"]))
    {
        if($_POST["total_ques"] != "" && $_POST["rollno"] != "" && $_POST["quizID"] != "")
        {
         ...
         //initializing the variables
            ...
            mysqli_query($con,"INSERT INTO `placement_data_1` (`email`,`Quants`, `LR`, `Verbal`, `Programming`, `CGPA`, `Networking`, `CC`, `WS`, `DA`, `QA`, `AI`) VALUES
            ('$roll_no', 0, 0, 0, '$marks', 0, 0, 0, 0, 0, 0, 0)")or die(mysqli_error($con));;
...
<html>
    ...
    <body  style="font-family: Arial;">
        ...
        <div id="head" align="center">
            <img src="img/header.jpg" alt="XIE" />
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center" id="video_link">
                            Home?!
                            <a href="../apply.php" style="color: #c4dcf5">
                                Back</a>
                            To see Result!
                        </td>
                        <td align="right" id="developer" >
                            Quiz Designed &amp; Developed by : 
                            <a href="mailto: sdrxie@gmail.com" class="flink" style="color: #c4dcf5">
