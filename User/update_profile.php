...
$query="update users set name='$n',mobile='$mob',gender='$gen',hobbies='$hob',dob='$dob' where email='".$_SESSION['username']."'";

//$query="insert into user values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$dob',now())";
mysqli_query($conn,$query);

$query2="update placement_data_1 set CGPA='$c' where email='".$_SESSION['username']."'";
...
$sql=mysqli_query($conn,"select * from users where email='".$_SESSION['username']."'");
$res=mysqli_fetch_assoc($sql);

$sql2=mysqli_query($conn,"select CGPA from placement_data_1 where email='".$_SESSION['username']."'");
...
<h2 align="center"><B>UPDATE YOUR PROFILE</B></h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Enter Your CGPA(average of all semesters) </td>
					<Td><input class="form-control" type="number" value="<?php echo $res2['CGPA'];?>"  name="c"/></td>
				</tr>
				<tr>
